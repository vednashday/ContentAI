...
import { auth, signInWithGoogle } from "../services/auth"; // Ensure this matches your path
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-500 text-sm mt-2 font-medium">
            Start generating high-performing social content.
          </p>
        </div>
        ...
        <div className="flex items-center my-6">
          ...
          <span className="px-4 text-[10px] text-zinc-600 font-bold uppercase tracking-widest">
            or
          </span>
          <div className="flex-1 border-t border-zinc-800"></div>
        </div>
